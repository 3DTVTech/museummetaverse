...
class JoyStick{
	constructor(options){
		...
		circle.style.cssText = "position:absolute; bottom:35px; width:100px; height:100px; background:rgba(126, 126, 126, 0.5); border:#444 solid medium; border-radius:50%; left:50%; transform:translateX(-50%);";
		const thumb = document.createElement("div");
		thumb.style.cssText = "position: absolute; left: 25px; top: 25px; width: 50px; height: 50px; border-radius: 50%; background: #fff;";
